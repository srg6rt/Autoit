...
While 1
	...
	Global $h = 0  ; 				 если выставить уровень нагрузки на колесо на максимум,
	Global $o = 0  ;                 колесо быстрее остановится, что повлияет на скорость откл. клавиатуры
	...
	Else
	Send("{w}") ; Посылаем нажатия клавиш перед блокировкой (от "залипания")
	Send("{s}")
	_BlockInputEx(3,0,'0x57|0x53|0x77|0x73') ; блокируем только клавиши w,s
